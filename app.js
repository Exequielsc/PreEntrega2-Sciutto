//  Definir un arreglo vacío para almacenar las frutas
var frutas = [];

// Definir un constructor para crear objetos de frutas
function Fruta(nombre) {
  this.nombre = nombre;
  this.cantidadLetras = nombre.length;
}

// Pedir al usuario que ingrese la cantidad de frutas que desea agregar (validar que sea un número)
var cantidadFrutas;
do {
  cantidadFrutas = parseInt(prompt("Ingrese la cantidad de frutas que desea agregar:"));
} while (isNaN(cantidadFrutas));

// Pedir al usuario que ingrese cada fruta y crear objetos de frutas con cantidad de letras automática
...
//  Crear una función que reciba un arreglo y devuelva la cantidad de elementos que contiene
function contarElementos(arreglo) {
  return arreglo.length;
}

// Llamar a la función contarElementos y mostrar el resultado por consola
console.log("Cantidad de frutas:", contarElementos(frutas));

// Crear un objeto que represente una persona con propiedades como nombre, edad y profesión (validar que la edad sea un número)
var persona = {
  nombre: null,
  edad: null,
  profesion: null
...
// Acceder a las propiedades del objeto persona y mostrarlas por consola
console.log("Nombre:", persona.nombre);
console.log("Edad:", persona.edad);
console.log("Profesión:", persona.profesion);

// Crear una función que reciba un arreglo y un elemento, y devuelva true si el elemento se encuentra en el arreglo, o false si no está
function buscarElemento(arreglo, elemento) {
  return arreglo.includes(elemento);
}

//  Pedir al usuario que ingrese la fruta que desea buscar
var frutaBuscada = prompt("Ingrese la fruta que desea buscar:").toLowerCase(); // Convertir a minúsculas

// Llamar a la función buscarElemento para buscar la fruta ingresada en el arreglo frutas (convertir los nombres a minúsculas para comparar)
...
// Filtrar el arreglo frutas para obtener solo las frutas que contienen la letra "a"
var frutasConA = frutas.filter(function (fruta) {
  return fruta.nombre.toLowerCase().includes("a");
});

// Mostrar por consola las frutas que contienen la letra "a" y la cantidad de letras que tienen
...
// Filtrar el arreglo frutas para obtener solo las frutas que no contienen la letra "a"
var frutasSinA = frutas.filter(function (fruta) {
  return !fruta.nombre.toLowerCase().includes("a");
});

// Mostrar por consola las frutas que no contienen la letra "a" y la cantidad de letras que tienen
